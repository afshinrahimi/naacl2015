...
class MLP():
    def __init__(self, 
        ...
        self.drop_out_coef = drop_out_coef
    ...
    def fit(self, X_train, Y_train, X_dev, Y_dev):
        ...
        drop_out_coef_input, drop_out_coef_hidden = self.drop_out_coef, self.drop_out_coef
        ...
        if not sp.sparse.issparse(X_train):
            ...
            logging.info('input matrix is sparse')
        ...
        l_in = SparseInputDropoutLayer(l_in, p=drop_out_coef_input)
        ...
        if self.add_hidden:
            ...
            self.l_hid1 = lasagne.layers.dropout(l_hid1, drop_out_coef_hidden)            
        ...
        logging.info('regul coefficient for output and hidden lasagne_layers are ' + str(self.regul_coef))
